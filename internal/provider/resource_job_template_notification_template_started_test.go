		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrPair("awx_job_template.test", "id",
						"awx_job_template_notification_template_started.test", "job_template_id"),
					TestAccCheckAttributeInList("awx_notification_template.test1", "id", "awx_job_template_notification_template_started.test", "notif_template_ids"),
				),
			},
			{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrPair("awx_job_template.test", "id",
						"awx_job_template_notification_template_started.test", "job_template_id"),
					TestAccCheckAttributeInList("awx_notification_template.test2", "id", "awx_job_template_notification_template_started.test", "notif_template_ids"),
					TestAccCheckAttributeInList("awx_notification_template.test3", "id", "awx_job_template_notification_template_started.test", "notif_template_ids"),
				),
			},
		},
	})
